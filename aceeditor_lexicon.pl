...
%----------------------------------------------------------------------------------------------------
% This is an example of a lexicon file for the ACE Editor. It follows the ACE Lexicon Specification
% (see http://attempto.ifi.uzh.ch/site/docs/ace_lexicon.html).
%----------------------------------------------------------------------------------------------------
